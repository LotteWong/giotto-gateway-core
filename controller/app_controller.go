...
// @Success 200 {object} middleware.Response{data=dto.ListAppsRes} "success"
// @Router /apps [get]
func (c *AppController) ListApps(ctx *gin.Context) {
	...
	if err != nil {
		middleware.ResponseError(ctx, 4002, err)
		return
	}
...
// @Success 200 {object} middleware.Response{data=po.App} "success"
...
func (c *AppController) UpdateApp(ctx *gin.Context) {
	...
	if err != nil {
		middleware.ResponseError(ctx, 4003, err)
		return
	}
